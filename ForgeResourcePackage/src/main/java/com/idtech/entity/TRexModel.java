package com.idtech.entity;// Made with Blockbench 3.9.3
...
public class TRexModel<T extends TRexEntity> extends EntityModel<T> {
	...
	public TRexModel() {
		...
		Body.addChild(Head);
		Head.setTextureOffset(0, 25).addBox(-3.0F, -17.4F, -15.2F, 5.0F, 2.0F, 7.0F, 0.0F, false);
		Head.setTextureOffset(21, 22).addBox(-2.0F, -18.4F, -17.2F, 3.0F, 1.0F, 9.0F, 0.0F, false);
		Head.setTextureOffset(41, 38).addBox(0.0F, -19.4F, -13.2F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		Head.setTextureOffset(24, 41).addBox(-2.0F, -19.4F, -13.2F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		Head.setTextureOffset(0, 16).addBox(-0.4F, -20.4F, -15.2F, 0.0F, 2.0F, 7.0F, 0.0F, true);
		Head.setTextureOffset(35, 18).addBox(-3.0F, -16.4F, -17.2F, 5.0F, 1.0F, 2.0F, 0.0F, false);
		Head.setTextureOffset(25, 0).addBox(-2.0F, -17.4F, -18.2F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(-3.0F, -15.4F, -17.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(-1.0F, -15.4F, -17.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(1.0F, -15.4F, -17.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(1.0F, -15.4F, -15.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(1.0F, -15.4F, -13.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(1.0F, -15.4F, -11.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(-3.0F, -15.4F, -11.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(-3.0F, -15.4F, -13.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(14, 23).addBox(-3.0F, -15.4F, -15.2F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		BottomJaw = new ModelRenderer(this);
		BottomJaw.setRotationPoint(0.0F, -15.0F, -9.0F);
		...
		LeftUpperArm.setRotationPoint(-6.0F, 0.0F, -4.0F);
		Body.addChild(LeftUpperArm);
		

		LeftUpperArm_r1 = new ModelRenderer(this);
		LeftUpperArm_r1.setRotationPoint(0.0F, -2.0F, 2.0F);
		...
		RightUpperArm.setRotationPoint(5.0F, 0.0F, -4.0F);
		Body.addChild(RightUpperArm);
		

		RightUpperArm_r1 = new ModelRenderer(this);
		RightUpperArm_r1.setRotationPoint(0.0F, -2.0F, 2.0F);
		...
		LeftLeg.setRotationPoint(-6.0F, 5.0F, 2.0F);
		Body.addChild(LeftLeg);
		LeftLeg.setTextureOffset(14, 41).addBox(0.0F, 1.0F, 0.0F, 3.0F, 4.0F, 2.0F, 0.0F, false);
		LeftLeg.setTextureOffset(0, 34).addBox(-1.0F, -4.0F, -1.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);
		LeftLeg.setTextureOffset(36, 22).addBox(0.0F, 5.0F, -1.0F, 3.0F, 1.0F, 4.0F, 0.0F, false);
		LeftLeg.setTextureOffset(30, 32).addBox(-1.0F, 5.0F, -4.0F, 5.0F, 1.0F, 3.0F, 0.0F, false);
		LeftLeg.setTextureOffset(36, 27).addBox(0.0F, 4.0F, -3.0F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		LeftLeg.setTextureOffset(17, 28).addBox(-1.0F, 4.0F, -4.0F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		LeftLeg.setTextureOffset(0, 28).addBox(-1.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		LeftLeg.setTextureOffset(25, 4).addBox(1.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		LeftLeg.setTextureOffset(16, 34).addBox(1.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		LeftLeg.setTextureOffset(12, 34).addBox(3.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		LeftLeg.setTextureOffset(32, 10).addBox(-1.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		LeftLeg.setTextureOffset(0, 25).addBox(3.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		LeftLeg.setTextureOffset(20, 34).addBox(1.0F, 5.0F, 3.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(6.0F, 5.0F, 2.0F);
		Body.addChild(RightLeg);
		RightLeg.setTextureOffset(14, 41).addBox(-3.0F, 1.0F, 0.0F, 3.0F, 4.0F, 2.0F, 0.0F, true);
		RightLeg.setTextureOffset(0, 34).addBox(-3.0F, -4.0F, -1.0F, 4.0F, 5.0F, 4.0F, 0.0F, true);
		RightLeg.setTextureOffset(36, 22).addBox(-3.0F, 5.0F, -1.0F, 3.0F, 1.0F, 4.0F, 0.0F, true);
		RightLeg.setTextureOffset(30, 32).addBox(-4.0F, 5.0F, -4.0F, 5.0F, 1.0F, 3.0F, 0.0F, true);
		RightLeg.setTextureOffset(36, 27).addBox(-3.0F, 4.0F, -3.0F, 3.0F, 1.0F, 3.0F, 0.0F, true);
		RightLeg.setTextureOffset(17, 28).addBox(-4.0F, 4.0F, -4.0F, 5.0F, 1.0F, 1.0F, 0.0F, true);
		RightLeg.setTextureOffset(0, 28).addBox(0.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, true);
		RightLeg.setTextureOffset(25, 4).addBox(-2.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, true);
		RightLeg.setTextureOffset(16, 34).addBox(-2.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, true);
		RightLeg.setTextureOffset(12, 34).addBox(-4.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, true);
		RightLeg.setTextureOffset(32, 10).addBox(0.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, true);
		RightLeg.setTextureOffset(0, 25).addBox(-4.0F, 5.0F, -6.0F, 1.0F, 1.0F, 2.0F, 0.0F, true);
		RightLeg.setTextureOffset(20, 34).addBox(-2.0F, 5.0F, 3.0F, 1.0F, 1.0F, 1.0F, 0.0F, true);
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		//TODO: Some sort of animation system
	}

	public TRexModel(ModelRenderer body, ModelRenderer bodySpike_r1, ModelRenderer head, ModelRenderer bottomJaw, ModelRenderer leftUpperArm, ModelRenderer leftUpperArm_r1, ModelRenderer leftHand, ModelRenderer handNail_r1, ModelRenderer rightUpperArm, ModelRenderer rightUpperArm_r1, ModelRenderer rightHand, ModelRenderer handNail_r2, ModelRenderer leftLeg, ModelRenderer rightLeg, ModelRenderer tail, ModelRenderer tail_r1, ModelRenderer bb_main, ModelRenderer waist_r1) {
		Body = body;
		BodySpike_r1 = bodySpike_r1;
		Head = head;
		BottomJaw = bottomJaw;
		LeftUpperArm = leftUpperArm;
		LeftUpperArm_r1 = leftUpperArm_r1;
		LeftHand = leftHand;
		HandNail_r1 = handNail_r1;
		RightUpperArm = rightUpperArm;
		RightUpperArm_r1 = rightUpperArm_r1;
		RightHand = rightHand;
		HandNail_r2 = handNail_r2;
		LeftLeg = leftLeg;
		RightLeg = rightLeg;
		Tail = tail;
		Tail_r1 = tail_r1;
