...
public class WitheringEnchantment extends Enchantment {
    ...
    public static Enchantment INSTANCE = new WitheringEnchantment(Rarity.UNCOMMON, EquipmentSlotType.MAINHAND).setRegistryName("wither_touch");

    // Constructor
    protected WitheringEnchantment(Rarity rarityIn, EquipmentSlotType... slots) {
